...
start:
	./test --docroot ./ --http-address 127.0.0.1 --http-port 8080 --config wt_config.xml
start2:
	./test --docroot ./ --http-address 127.0.0.1 --http-port 8080 --config wt_config.xml --https-address 0.0.0.0 \
    --ssl-certificate server.pem \
    --ssl-private-key /home/paul/Desktop/server.key \
