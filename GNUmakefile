...
$(builddir)/test: $(builddir)/test_CustomRegistrationWidget.o $(builddir)/test_CustomAuthWidget.o $(builddir)/test_SingleGroupsControl.o $(builddir)/test_GroupsControl.o $(builddir)/test_BridgeControl.o $(builddir)/test_LightsControl.o $(builddir)/test_HueApp.o $(builddir)/test_Main.o $(builddir)/test_Session.o $(builddir)/test_User.o
	$(CXX) -o $@ $(LDFLAGS) $(builddir)/test_CustomRegistrationWidget.o $(builddir)/test_CustomAuthWidget.o $(builddir)/test_SingleGroupsControl.o $(builddir)/test_GroupsControl.o $(builddir)/test_BridgeControl.o $(builddir)/test_LightsControl.o $(builddir)/test_HueApp.o $(builddir)/test_Main.o $(builddir)/test_Session.o $(builddir)/test_User.o -lwt -lwthttp -lboost_system -lwtdbo -lwtdbosqlite3 -lcrypt -pthread
